...
import com.dounine.catwechat.router.routers._
import com.dounine.catwechat.shutdown.Shutdowns
import com.dounine.catwechat.startup.Startups
...
object App {
  ...
  def main(args: Array[String]): Unit = {
    ...
    implicit val system = ActorSystem(Behaviors.empty, "catwechat")
