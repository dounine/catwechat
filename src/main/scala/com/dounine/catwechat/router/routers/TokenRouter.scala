...
import com.dounine.catwechat.behaviors.engine.AccessTokenBehavior.TokenResponse
import com.dounine.catwechat.behaviors.engine.{
  AccessTokenBehavior,
  JSApiTicketBehavior
}
import com.dounine.catwechat.model.models.TokenModel
...
class TokenRouter()(implicit system: ActorSystem[_]) extends SuportRouter {
  ...
  val wechat = system.settings.config.getConfig("app")
